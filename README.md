...
Viewing the result in the IDE is preferable for this function, as the returned string is preformatted with linefeeds and spaces prefixing attribute names.  If you view the result in ECL Watch then the linefeeds are ignored, which puts everything on one line.
